  ...
  return (
    <form className="flex flex-col gap-8 pb-10" onSubmit={onUpdateSettings}>
      <div className=" flex flex-col gap-3">
        <h2 className="font-bold text-2xl ">DomainSettings</h2>
      ...
      <div className="flex flex-col gap-3 mt-5">
        <div className="flex gap-4 items-center">
          ...
          <div
            className={cn(
              'flex gap-1 bg-cream rounded-full px-3 py-1 text-xs items-center font-bold text-gray-500',
              resolvedTheme == 'dark' && 'bg-gray-800 text-gray-400'
            )}
          >
            <PremiumBadge />
            Premium
